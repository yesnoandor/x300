    ...
    public void initAndLoop() {
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
			...
			try {
                  ...
                  Slog.i(TAG, "Add Spider Service");

                  ServiceManager.addService("spider", new SpiderService(context));

            } catch (Throwable e) {

                  Slog.e(TAG, "Failure starting Spider Service", e);
            }
...
public class SystemServer {
    ...
    //yinqi 2016/6/6
    private static final long EARLIEST_SUPPORTED_TIME = 946656000000L;//1404187200000L;
