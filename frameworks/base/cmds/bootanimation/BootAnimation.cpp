...
// modify by fleety jie.liu start
//#define SYSTEM_BOOTANIMATION_FILE "/system/media/bootanimation.zip"
#define SYSTEM_BOOTANIMATION_FILE "/system/media/bootanimationfleety.zip"
// modify by fleety jie.liu end 
#define SYSTEM_ENCRYPTED_BOOTANIMATION_FILE "/system/media/bootanimation-encrypted.zip"

// modify by fleety jie.liu start
//#define USER_SHUTDOWN_ANIMATION_FILE "/data/local/shutdownanimation.zip"
#define USER_SHUTDOWN_ANIMATION_FILE "/data/local/shutdownanimationfleety.zip"
// modify by fleety jie.liu end 
