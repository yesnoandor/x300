...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /* zhangzhaolei add for remove profiles 20150518 start */
            loadIntegerSetting(stmt, Settings.System.SYSTEM_PROFILES_ENABLED,
                    R.integer.def_profiles_enabled);
            /* zhangzhaolei add for remove profiles 20150518 end */
        } finally {
            if (stmt != null) stmt.close();
        }
    }
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /* zhangzhaolei add for default input method 20150605 satrt */
            loadStringSetting(stmt, Settings.Secure.DEFAULT_INPUT_METHOD, R.string.default_input_method);
            /* zhangzhaolei add for default input method 20150605 end */
		    ...
		    Log.i(TAG, "set default tts engine");
	  		loadStringSetting(stmt, Settings.Secure.TTS_DEFAULT_SYNTH,R.string.tts_default_synth);
