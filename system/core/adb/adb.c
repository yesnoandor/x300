...
int adb_main(int is_daemon, int server_port)
{
	...
	// fleety : enable adb auth if no imei start 
    // xugq modify, disable adb auth if no imei
    //if (auth_enabled) {
    //    property_get("ro.bootmode", value, "unknown");
    //    if (!strcmp(value, "noimei")) {
    //        auth_enabled = 0;
    //    }
    //}
    // xugq end.
	// fleety : enable adb auth if no imei end
