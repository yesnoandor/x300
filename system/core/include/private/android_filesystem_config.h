...
static const struct fs_path_config android_files[] = {
	...
	{ 00555, AID_ROOT,      AID_SHELL,     0, "system/scripts/init.shell.sh" },
	{ 00555, AID_ROOT,      AID_SHELL,     0, "system/scripts/init.iptables.sh" },
	{ 00555, AID_ROOT,      AID_SHELL,     0, "system/scripts/init.event.sh" },
	{ 00555, AID_ROOT,      AID_SHELL,     0, "system/scripts/recovery.sh" },
