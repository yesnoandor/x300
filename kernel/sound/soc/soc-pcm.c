...
static int soc_pcm_close(struct snd_pcm_substream *substream)
{
	...
	//dprintk(KERN_ERR "stream = %d\r\n",substream->stream);

	if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK) {
		//dprintk(KERN_ERR "pmdown_time = %ld\r\n",rtd->pmdown_time);
		//dprintk(KERN_ERR "ignore_pmdown_time = %d\r\n",rtd->dai_link->ignore_pmdown_time);
		//dprintk(KERN_ERR "ignore_pmdown_time2 = %d\r\n",codec->ignore_pmdown_time);
		...
		if (!rtd->pmdown_time || codec->ignore_pmdown_time ||
			...
			//dprintk(KERN_ERR "pmdown_time111 = %ld\r\n",rtd->pmdown_time);
...
static int soc_pcm_trigger(struct snd_pcm_substream *substream, int cmd)
{
	...
	*/
	...
	//dprintk(KERN_ERR "cmd = %d\r\n",cmd);

	//dprintk(KERN_ERR "codec_dai name = %s\r\n",codec_dai->name);
	//dprintk(KERN_ERR "codec_dai id = %d\r\n",codec_dai->id);
	
	//dprintk(KERN_ERR "cpu_dai name = %s\r\n",cpu_dai->name);
	//dprintk(KERN_ERR "cpu_dai id = %d\r\n",cpu_dai->id);

	//dprintk(KERN_ERR "platform name = %s\r\n",platform->name);
	//dprintk(KERN_ERR "platform id = %d\r\n",platform->id);


	
	if (codec_dai->driver->ops->trigger) {
		//dprintk(KERN_ERR "codec dai trigger!!\r\n");
	...
	if (platform->driver->ops && platform->driver->ops->trigger) {
		//dprintk(KERN_ERR "platform trigger!!\r\n");
	...
	if (cpu_dai->driver->ops->trigger) {
		//dprintk(KERN_ERR "cpu dai trigger!!\r\n");
