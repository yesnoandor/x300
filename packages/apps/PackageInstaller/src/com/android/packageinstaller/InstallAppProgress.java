...
public class InstallAppProgress extends Activity implements View.OnClickListener, OnCancelListener {
            ...
            switch (msg.what) {
                case INSTALL_COMPLETE:
                    ...
                    if (msg.arg1 == PackageManager.INSTALL_SUCCEEDED) {
                        ...
                        if (enabled) {
							// fleety jie.liu modify (add if-false) start (disable packaget install dialog)
							...
							// fleety jie.liu modify (add if-false) end (disable packaget install dialog)
                        } else {
    ...
    public void onCreate(Bundle icicle) {
		...
		// fleety jie.liu modify start (disable packaget install dialog)
        //yinqi add 2015/7/20, don't show the location diaglog, use default location
        //showAppInstallLocationSettingDlg();
        initView();
		// fleety jie.liu modify end(disable packaget install dialog)
    }
