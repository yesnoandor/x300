...
public class InCallPresenter implements CallList.Listener {
    ...
    private void startUi(InCallState inCallState) {
        /* fleety John Fan add start */
        if(true){
            Log.d("fleety_phone", "InCallPresenter :startUi()  not start activity");
        return;
        }
        /* fleety John Fan add end */
    ...
    private void showInCall(boolean showDialpad) {
        ...
        Log.d("fleety_phone", "InCallPresenter :showInCall()  not start activity");
