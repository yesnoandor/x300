...
public class DeviceInfoSettings extends RestrictedSettingsFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        /* zhangzhaolei add for software && hardware version 20150603 start */
        if(SystemProperties.getBoolean("ro.sw_version_enable", false)) {	
            //setStringSummary(KEY_BUILD_NUMBER, Build.DISPLAY_SW);
            
            String STM32_SW = SystemProperties.get("sys.stm32.sw.version","MSM742.0000");
			setStringSummary(KEY_BUILD_NUMBER, STM32_SW);
		}
        if(SystemProperties.getBoolean("ro.hw_version_enable", false)) {
            //setStringSummary(KEY_HARDWARE_VERSION, Build.DISPLAY_HW);
            String STM32_HW = SystemProperties.get("sys.stm32.hw.version","MSM742.0000");
			setStringSummary(KEY_HARDWARE_VERSION, STM32_HW);
        }
        /* zhangzhaolei add for software && hardware version 20150603 end */
    ...
    public static String formatKernelVersion(String rawKernelVersion) {
        ...
        return m.group(1) + "\n" +                 // 3.0.31-g6fb96c9
            ...
            //m.group(2) + " " + m.group(3) + "\n" + // x@y.com #1 yinqi comments this line to meet client's request 
    }
