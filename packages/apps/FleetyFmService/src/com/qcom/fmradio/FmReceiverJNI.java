package com.qcom.fmradio;

public class FmReceiverJNI
{
	 static
	 {
	  	 System.loadLibrary("qcomfm");
	 }
	  ...
	  * @return
	  */
	 public static native int audioControlNative(int fd, int control, int field);
	  ...
	  * 			{@link #FM_JNI_FAILURE}
	  */
	 public static native int cancelSearchNative(int fd);
	  ...
	  */
	 public static native int getFreqNative(int fd);
	  ...
	  *
	  */
	 public static native int setFreqNative(int fd, int freq);
	  ...
	  * 		v4l2 control
	  */
	 public static native int getControlNative (int fd, int id);
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int setControlNative (int fd, int id, int value);
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int startSearchNative (int fd, int dir);
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int getBufferNative (int fd, byte  buff[], int index);
	  ...
	  */
	 public static native int getRSSINative (int fd);
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int setBandNative (int fd, int low, int high);
	  ...
	  */
	 public static native int getLowerBandNative (int fd);
	  ...
	  */
	 public static native int getUpperBandNative (int fd);
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int setMonoStereoNative (int fd, int val);
	  ...
	  */
	 public static native int getRawRdsNative (int fd, byte  buff[], int count);
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int setNotchFilterNative(int fd, int id, boolean value);
	
	 /**
	  * native method: enable/disable Analog Mode
	  */
	 public static native int setAnalogModeNative(boolean value);
	  ...
	  * @return Returns number of bytes read
	  */
	 public static native int startRTNative(int fd, String str, int count);
	  ...
	  * @return Returns number of bytes read
	  */
	 public static native int stopRTNative(int fd);
	  ...
	  * @return Returns number of bytes read
	  */
	 public static native int startPSNative(int fd, String str, int count);
	  ...
	  * @param count number of bytes to be read
	  */
	 public static native int stopPSNative(int fd);
	/**
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int setPTYNative (int fd, int pty);
	...
	/**
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int setPINative (int fd, int pi);
	...
	/**
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int setPSRepeatCountNative(int fd, int repeatCount);
	/**
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int setTxPowerLevelNative(int fd, int powLevel);
	/**
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int SetCalibrationNative(int fd);
	...
	/**
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int configureSpurTable(int fd);
	  ...
	  * 		{@link #FM_JNI_FAILURE}
	  */
	 public static native int setSpurDataNative(int fd, short	buff[], int len);
	 public static native void configurePerformanceParams(int fd);
