...
public class CallNotifier extends Handler
    ...
    protected void showCallDurationIfNeed(Connection c) {
	    ...
	    /*suheng modify jira:APLUS-50 for one call has two records in BlockRecord 20150824 start*/
            //Phone phone = c.getCall().getPhone();
            //String number = c.getAddress();
            //int subscription = phone.getSubscription();
            //sendBlockRecordBroadcast(subscription,number);
	    /*suheng modify jira:APLUS-50 for one call has two records in BlockRecord 20150824 end*/
        } else {
            /* fleety John Fan del start */   
           // mApplication.showCallDuration(c.getDurationMillis());
            /* fleety John Fan del end */   
        }
    }
    ...
    protected void onDisconnect(AsyncResult r) {
        ...
        /* zhangzhaolei add jira:XT-28 callingTime become long 290150820 start */
        //PhoneNumberUtils.resetCountryDetectorInfo();
        /* zhangzhaolei add jira:XT-28 callingTime become long 290150820 end */
